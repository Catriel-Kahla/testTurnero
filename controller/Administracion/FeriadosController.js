const getFeriados = () => { 
  ...
  const myRequest = new Request(`${baseUrl}Administracion/FeriadosServices.p${params}`, options);
  fetch(myRequest)
    .then(response => { 
      if (!response.ok) {
    ...
    .then(data => {  console.log(data)
      ...
      data.forEach(element => { 
        ...
        ` <tr class="border p-3">
          ...
          <td class="font-weight-normal text-left">${element.tipo}</td>
            ...
            <div class="dropdownleft">
              ...
              <div class="dropdown-menu bg-primarysoft" aria-labelledby="dropdownMenuButton">
                ...
                <a 
                  ...
                  href="./FeriadoEdit.html?p-id=${element.id}">Editar</a>
                <hr class="my-0 py-0">
...
const TramiteDelete = (id, fecha) => {  
  ...
  function() { 
      ...
      const myRequest = new Request(`${baseUrl}Administracion/FeriadosServices.p`, options);
      fetch(myRequest)
          .then(response => { 
              if (!response.ok) {
                throw new Error('Problema con la respuesta del servidor');
